...
setenv CESM2_TOOLS_ROOT /glade/work/nanr/cesm_tags/CASE_tools/cesm2-smyle-DP/pp-offline/sashaScripts/
setenv DOUT_S_ROOT  /glade/scratch/nanr/SMYLE-EXTEND/archive/
...
foreach YEAR ( `seq 1958 1958` )
	foreach mbr ( `seq 21 30` )
...
#		pp_config --set TIMESERIES_OUTPUT_ROOTDIR=/glade/scratch/$USER/timeseries/$CASE
		pp_config --set TIMESERIES_OUTPUT_ROOTDIR=/glade/campaign/cesm/development/espwg/CESM2-DP/timeseries/$CASE
		...
		sed -i "s/tSP/t${YEAR}-${mbr}/g" $CASEROOT/$CASE/postprocess/timeseries
		qsub timeseries
	end 
end
