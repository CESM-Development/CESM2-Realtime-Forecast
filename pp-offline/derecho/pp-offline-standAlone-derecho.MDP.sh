...
setenv DOUT_S_ROOT  /glade/derecho/scratch/nanr/SMYLE-MDP/archive/
#setenv DOUT_S_ROOT  /glade/derecho/scratch/sglanvil/SMYLE-MDP/archive/
...
foreach YEAR ( `seq 2023 2023` )
	foreach mbr ( `seq 1 1` )
		...
		#set CASE = b.e21.BSMYLE.f09_g17.MDP.${YEAR}-11.${mbr_padZeros}
		set CASE = b.e21.BSMYLE-XT-beta.f09_g17.MDP.2023-11.${mbr_padZeros}
...
#		pp_config --set TIMESERIES_OUTPUT_ROOTDIR=/glade/scratch/$USER/timeseries/$CASE
		pp_config --set TIMESERIES_OUTPUT_ROOTDIR=/glade/campaign/cesm/development/espwg/CESM2-MDP/timeseries/$CASE
