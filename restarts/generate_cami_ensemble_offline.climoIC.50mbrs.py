...
def parse_command_line(args, description):
    ...
    parser.add_argument("--ensemble-end",default=50,
...
def get_rvals(date, ensemble_start,ensemble_end, model):
    ...
    rvals_file = os.path.join("/glade/campaign/cesm/development/espwg/SMYLE-CASES/CESM2-SMYLE/","cases","camic_"+date+".{}-{}.txt".format(ensemble_start,ensemble_end))
...
def create_cam_ic_perturbed(original, ensemble_start,ensemble_end, date, baserundir, model, outroot="b.e21.SMYLE_climoIC.pert.f09_g17.cam.i.", factor=0.15):
    ...
    pertroot = os.path.join("/glade/campaign/cesm/development/espwg/SMYLE/inputdata/cesm2_init","b.e21.SMYLE_climoIC.f09_g17."+date[0:7]+".01","pert.01")
...
def _main_func(description):
    ...
    sdrestdir = os.path.join("/glade/campaign/cesm/development/espwg/SMYLE/inputdata/cesm2_init/","b.e21.SMYLE_climoIC.f09_g17."+date[0:7]+".01","{}".format(date))
    user = os.getenv("USER")
    baserundir = os.path.join("/glade/derecho/scratch/{}/".format(user),"SMYLE","b.e21.BSMYLE.f09_g17."+date[0:7]+".001","run.{:03d}".format(ensemble_start))
    caminame = os.path.join(sdrestdir,"b.e21.SMYLE_climoIC.f09_g17.{}.01.cam.i.{date}-00000.nc".format(date[:7],date=date))
    outroot = "b.e21.SMYLE_climoIC.pert.f09_g17.cam.i."
