...
#caseroot='/glade/campaign/cesm/development/espwg/SMYLE-CASES/CESM2-SMYLE-DP/cases/bySasha/'
...
./xmlchange DOUT_S_ROOT=/glade/derecho/scratch/$USER/SMYLE-DP/archive/$runname/
./xmlchange CIME_OUTPUT_ROOT=/glade/derecho/scratch/$USER/SMYLE-DP
...
echo "made it this far"
  ...
  # Lastly - copy Initial conditions
    ics="/glade/derecho/scratch/nanr/SMYLE/archive/b.e21.BSMYLE.f09_g17.${useyear}-${usemonth}.$mbr/rest/"

    ls ${rundir}

    # pre-stage ICs
    cp ${ics}/${restyear}-${usemonth}-01-00000/rpointer.* ${rundir}/
    cp ${ics}/${restyear}-${usemonth}-01-00000/b.e21.* ${rundir}/
