...
setenv ARCHDIR1  /glade/derecho/scratch/$USER/SMYLE-MDP/archive/
#setenv ARCHDIR1  /glade/derecho/scratch/sglanvil/SMYLE-MDP/archive/
setenv TSERIES  /glade/campaign/cesm/development/espwg/CESM2-MDP/timeseries
setenv LOGSDIR  /glade/campaign/cesm/development/espwg/CESM2-MDP/logs
setenv POPDDIR  /glade/campaign/cesm/development/espwg/CESM2-MDP/popd
...
if ($mbr < 10) then
	#set CASE = b.e21.BSMYLE.f09_g17.MDP.${year}-${mon}.00${mbr}
        set CASE = b.e21.BSMYLE-XT-beta.f09_g17.MDP.${year}-${mon}.00${mbr}
else
	#set CASE = b.e21.BSMYLE.f09_g17.MDP.${year}-${mon}.0${mbr}
        set CASE = b.e21.BSMYLE-XT-beta.f09_g17.MDP.${year}-${mon}.0${mbr}
endif
