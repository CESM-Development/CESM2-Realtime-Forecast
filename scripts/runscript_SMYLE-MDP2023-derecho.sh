...
./xmlchange RUN_REFCASE=b.e21.SMYLE_IC.v2.f09_g17.${useyear}-${usemonth}.01
...
echo "made it this far"
  ...
  # Lastly - copy Initial conditions
    ...
    camic="b.e21.SMYLE_IC.v2.f09_g17.${useyear}-${usemonth}.01.cam.i.${useyear}-${usemonth}-01-00000.nc"
    pertcamic="b.e21.SMYLE_IC.pert.f09_g17.cam.i.${useyear}-${usemonth}-01-00000.nc"
    ics="/glade/campaign/cesm/development/espwg/SMYLE/inputdata/cesm2_init/b.e21.SMYLE_IC.v2.f09_g17.${useyear}-${usemonth}.01/"
