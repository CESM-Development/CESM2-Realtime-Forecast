...
./xmlchange DOUT_S_ROOT=/glade/derecho/scratch/nanr/SMYLE-DP/archive/$runname/
...
echo "made it this far"
  ...
  # Lastly - copy Initial conditions
    ics="/glade/derecho/scratch/nanr/SMYLE/archive/b.e21.BSMYLE-XT-beta.f09_g17.${useyear}-${usemonth}.$mbr/rest/"
