...
echo 'Case   = ' $CASE
  ...
  setenv DPDIR    /glade/scratch/$USER/SMYLE-DP/
  setenv RUNDIR   /$DPDIR/$CASE/run
  setenv CASEROOT /glade/campaign/cesm/development/espwg/SMYLE-CASES/CESM2-SMYLE-DP/cases/$CASE
  ...
  cd $CASEROOT
  ./xmlchange CIME_OUTPUT_ROOT=/glade/scratch/$USER/SMYLE-DP/
  ./xmlchange RUNDIR=/glade/scratch/$USER/SMYLE-DP/$CASE/run.0${mbr}
...
# ./preview_namelists
  ./case.setup --reset 
  ./xmlchange EXEROOT=/glade/scratch/$USER/SMYLE-DP/exerootdir/bld/
